...
public interface AtmotubeConstants {
    ...
    public static final UUID VOC_CHARACTERISTIC_UUID_V3 = UUID.fromString("db450002-8e9a-4818-add7-6ed94a328ab3");         // 	4 bytes
    public static final UUID BME280_CHARACTERISTIC_UUID_V3 = UUID.fromString("db450003-8e9a-4818-add7-6ed94a328ab3");      // 	6 bytes
    public static final UUID STATUS_CHARACTERISTIC_UUID_V3 = UUID.fromString("db450004-8e9a-4818-add7-6ed94a328ab3");      // 	2 bytes
    public static final UUID PM_CHARACTERISTIC_UUID_V3 = UUID.fromString("db450005-8e9a-4818-add7-6ed94a328ab3");          // 	6 bytes
